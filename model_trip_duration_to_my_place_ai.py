...
############################# START OF EXERCISE 1 #############################
    ...
    data_quality_task = GreatExpectationsOperator(
        ...
        # Set `data_asset_name` value equal to `"train_to_my_place_ai"`
        ...
        dataframe_to_validate=pd.read_parquet(
            ...
            f"to_my_place_ai/train.parquet"
        ),
    ...
    # Remember to add the `to_my_place_ai` parameter when necessary. You will use 
