...
RAW_DATA_BUCKET = "de-c2w4lab1-211052710839-us-east-1-raw-data"
### END CODE HERE ###
...
with DAG(
    ...
    def get_new_users(**context):
        ...
        response = requests.get(
            f"http://3.217.112.125:8000/users?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_session(**context):
        ...
        # APIEndpoint to fill the `<API_ENDPOINT>` placeholder.
        response = requests.get(
            f"http://3.217.112.125:8000/sessions?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_user_info(**context):
        ...
        for session in session_info:
            ...
            response = requests.get(
                f"http://3.217.112.125:8000/users_by_id?user_ids={user_id}"
            )
